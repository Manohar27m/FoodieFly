<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.tap.model.Cart,com.tap.model.CartItem,com.tap.model.Restaurant" %>
...
<body>
        ...
        <div class="cart-container">
            <div class="restaurant-details">
                <div class="restaurant-image">
                    <img src="https://b.zmtcdn.com/data/pictures/chains/2/50382/6fa52a1c7dad34faa24f1bae4e7159de.jpg" 
                ...
                <div class="restaurant-info">
                    ...
                    <div class="restaurant-meta">
                        ...
                        <div class="delivery-time">
                            ...
                            <span><%= restaurant.getDeliveryTime() %> -  <%= restaurant.getDeliveryTime() + 5%> mins</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="cart-item">
                    ...
                    <div class="quantity-controls">
                    	...
                    	<form action="CartServlet" method="post" style="display: inline">
                    		<input type="hidden" name="itemId" value="<%= item.getItemiId() %>">
            ...
            <div class="order-notice">
                ...
                <ul class="notice-list">
                    <li>
                        ...
                        <span>Please verify your delivery address and contact details</span>
                    </li>
                    <li>
                        <i class="fas fa-clock"></i>
                        <span>Orders cannot be canceled once the restaurant begins preparing your food</span>
                    </li>
                    <li>
                        <i class="fas fa-info-circle"></i>
                        <span>Customization requests cannot be modified after order confirmation</span>
                    </li>
                    <li>
                        <i class="fas fa-rupee-sign"></i>
                        <span>This order, if cancelled, is non-refundable.</span>
                    </li>
                </ul>
            </div>
    ...
    <button class="btn add-more-btn" onclick="window.location.href='menuServlet?restaurantId=<%=session.getAttribute("restaurantId")%>'">
        ➕ Add More Items
    </button>
